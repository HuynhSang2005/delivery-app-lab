# OpenAPI Extended Reference

Detailed examples and extended content for OpenAPI specification generation.

## Extended Template 1: Complete API Specification Components

The following section contains the complete `components` section for the User Management API specification referenced in the main SKILL.md file.
...
FastAPI automatically generates OpenAPI specs from your Python code:
...
tsoa generates OpenAPI specs from TypeScript decorators:
...
- **OpenAPI Generator**: Most comprehensive, supports 50+ languages
- **swagger-codegen**: Original Swagger generator
- **kiota** (Microsoft): Modern generator for REST APIs
- **orval**: TypeScript-focused, generates React Query hooks
